-- Modifier compute_chantier_metrics pour ajouter marge_finale et marge_finale_pct
...
BEGIN
  ...
  -- ✨ NOUVEAU : Calcul de la marge finale (projection à la fin du chantier)
...
-- Recalculer toutes les métriques existantes avec les nouveaux champs
