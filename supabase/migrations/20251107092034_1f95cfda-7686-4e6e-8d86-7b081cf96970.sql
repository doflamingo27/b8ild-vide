-- Corriger insert_extraction_service pour inclure chantier_id dans factures_fournisseurs
...
BEGIN
  ...
  v_chantier_id := (p_data->>'chantier_id')::uuid;
  ...
  IF p_table = 'factures_fournisseurs' THEN
    INSERT INTO factures_fournisseurs (
      id, entreprise_id, chantier_id, montant_ht, tva_pct, tva_montant, montant_ttc,
      fournisseur, siret, date_facture, categorie,
      extraction_json, confiance, pages_count, extraction_status, created_at
    ) VALUES (
      v_id, p_entreprise_id, v_chantier_id, v_montant_ht, v_tva_pct, v_tva_montant, v_montant_ttc,
